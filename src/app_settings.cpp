...
AppSettings::AppSettings()
    : auto_start_("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", QSettings::NativeFormat),
...
void AppSettings::read()
{
    ...
    this->hide_window_initially = others_.value("hide_window_initially").value<bool>();
}
